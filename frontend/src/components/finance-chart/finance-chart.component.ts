  ...
  implements AfterViewInit, OnChanges, OnDestroy
{
  ...
  private monthlyCanvas?: ElementRef<HTMLCanvasElement>;
  @ViewChild("cumulativeChart")
  private cumulativeCanvas?: ElementRef<HTMLCanvasElement>;
  ...
  private renderCharts(): void {
    if (!this.viewReady || !this.monthlyCanvas || !this.cumulativeCanvas)
      return;
